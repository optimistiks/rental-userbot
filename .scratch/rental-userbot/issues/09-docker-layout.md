...
- File paths inside it: mtcute session, dedupe DB (`bot.sqlite`, a separate file, decided in Telegram boundary and Post shape), Criteria. What `CRITERIA_PATH` defaults to.
